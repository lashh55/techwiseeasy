...
export default function StoryStepFamily({ value, onSelect, onNext }) {
  ...
  return (
    <div className="flex flex-col items-center px-5 py-4 gap-4">
      <div className="text-center">
        ...
        <h2 className="text-white font-black text-2xl leading-tight">Family Situation</h2>
        <p className="text-white/70 font-semibold text-base mt-1">Tell us a little about you.</p>
      </div>

...
export default function ComputerPopupButtonBubble({ scenario }) {
  return (
        ...
        <div className="relative bg-gray-100 h-56 flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 bg-white rounded-xl border-4 border-red-600 shadow-2xl mx-4 w-full max-w-xs">
            ...
            <div className="bg-red-600 px-3 py-2 rounded-t-lg flex items-center gap-2">
              <span className="text-white text-sm font-black">⚠️ SECURITY WARNING</span>
            </div>
            {/* Body */}
            <div className="px-4 py-3 flex flex-col items-center text-center gap-2">
              <p className="text-red-700 font-black text-xs leading-tight">
                Your computer may be infected. Microsoft has detected harmful software on this device.
              </p>
              <p className="text-gray-700 font-bold text-xs">
                Click below to remove the threat now.
              </p>
              {/* Fake button — not clickable */}
              <div className="w-full bg-red-600 text-white font-black text-xs py-2 px-3 rounded-lg text-center cursor-default select-none">
                SCAN AND REMOVE VIRUS
              </div>
              <p className="text-gray-500 text-xs">
                Closing this page may result in data loss.
              </p>
            </div>
          </div>
        </div>

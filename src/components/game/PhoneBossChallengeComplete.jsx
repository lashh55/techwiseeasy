...
export default function PhoneBossChallengeComplete({ totalPoints, onClaim }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-navy via-brand-blue to-navy flex flex-col items-center justify-center px-6 py-10 text-center">
      ...
      >
        {lang === 'es' ? '¡Experta en Llamadas!' : 'Phone Expert Unlocked!'}
      </motion.h1>
      ...
      >
        {lang === 'es' ? 'Completaste el Reto Final de Llamadas' : 'You completed the Phone Boss Challenge'}
      </motion.p>
      ...
      {showBadge && (
        ...
        >
          ...
          <p className="text-gold font-black text-lg">
            {lang === 'es' ? 'Insignia: Experta en Llamadas' : 'Badge: Phone Expert'}
          </p>
